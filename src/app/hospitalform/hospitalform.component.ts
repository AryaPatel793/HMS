...
export class HospitalformComponent implements OnInit {
  ...
  constructor(private http:HttpClient, private toastr: ToastrService, private hospitalService : HospitalService, private notificationService : NotificationService, private router: Router, private route: ActivatedRoute){
  ...
  saveHospital() {
    ...
    if(result.equals("Hospital added successfully"))
    {
